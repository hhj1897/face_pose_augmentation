...
public:
    ...
    FaceFrontalization(
        const std::int32_t *tri_ind, int width, int height, const double *all_vertex_src,
        const double *all_vertex_ref, int all_ver_length, const std::int32_t *all_tri, int all_tri_length);
