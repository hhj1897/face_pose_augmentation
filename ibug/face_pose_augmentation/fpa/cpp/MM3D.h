...
namespace MM3D {
    void ZBuffer(const double *vertex, const int *tri, const double *texture, int nver, int ntri,
        const double *src_img, int width, int height, int nChannels, double *img, int *tri_ind);
    void ZBufferTri(const double *vertex, const int *tri, const double *texture_tri, int nver, int ntri,
        const double *src_img, int width, int height, int nChannels, double *img, int *tri_ind);
