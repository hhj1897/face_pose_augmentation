...
cdef extern from "cpp/MM3D.h":
    void _ZBuffer "MM3D::ZBuffer" (double*, double*, double*, int, int, double*, int, int, int, double*, double*)
    void _ZBufferTri "MM3D::ZBufferTri" (double*, double*, double*, int, int, double*, int, int, int, double*, double*)
...
def  ZBuffer(cnp.ndarray[double, ndim=2, mode="fortran"] vertex not None,
                  cnp.ndarray[double, ndim=2, mode="fortran"] tri not None,
    ...
    cdef cnp.ndarray[double, ndim=3, mode="fortran"] tri_ind
