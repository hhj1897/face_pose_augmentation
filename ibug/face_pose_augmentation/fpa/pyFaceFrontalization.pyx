...
cdef extern from "cpp/face_frontalization.h":
    cdef cppclass FaceFrontalization:
        ...
        FaceFrontalization(const long*, int, int, const double*, const double*, int, int, const long*, int, int)
...
def pyFaceFrontalizationMappingNosym(np.ndarray[long, ndim=2, mode='c'] tri_ind not None,
                                     width, height,
                                     ...
                                     np.ndarray[long, ndim=2, mode='c'] all_tri not None,
                                     all_tri_dim, all_tri_length):
    ...
    cdef FaceFrontalization c_ff = FaceFrontalization(
        ...
        &all_tri[0, 0], all_tri_dim, all_tri_length)
